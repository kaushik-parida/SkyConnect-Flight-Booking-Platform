...
public class BookingServiceImplementationTest {
	...
	void test_createBooking_multiplePassengers_seatsCalculatedFromList() {
		...
		Booking savedBooking = Booking.builder().bookingId(99L).bookingRef("FLY1234567").numberOfSeats(2)
	...
	void test_createBooking_nullMealPreference_defaultsToNone() {
		...
		Booking savedBooking = Booking.builder().bookingId(1L).bookingRef("FLY1234567").status(BookingStatus.CONFIRMED)
				.build();
	...
	@Test
	@DisplayName("createBooking: available seats should be sum of economy and business seats")
	void test_createBooking_availableSeatsIsSumOfEconomyAndBusiness() {
